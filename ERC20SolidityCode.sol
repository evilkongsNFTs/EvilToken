...
contract EVILTOKEN is ERC20, ERC20Burnable, Ownable, AutomationCompatibleInterface {
    ...
    constructor() ERC20("EVILK", "EKT") { 
        // Sets the keeper update interval.
        interval = updateInterval;
        lastTimeStamp = block.timestamp;
        counter = 0;
        // set the price feed address to
        // ETH/USD Price Feed Contract Address on Goreli: https://goerli.etherscan.io/address/0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e
        // or the MockPriceFeed Contract
        priceFeed = AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
        currentPrice = getLatestPrice();
        _mint(msg.sender, 16666666 * 10 ** 18);
    }
